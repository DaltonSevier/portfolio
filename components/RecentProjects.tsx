    ...
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap item-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
            {projects.map(({id, title, des, img, iconLists, link}) => (
                <a key={id} className='sm:h-[41rem] h-[32rem] sm:w-[570px] lg:min-h-[32.5rem] flex items-center justify-center w-[90vw]' href={link || '#'} target='_blank'>
                    <PinContainer title={link} href={link}>
                        <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] lg:h-[30vh] mb-10'>
                            ...
                            <img src={img} alt={title} className='z-10 asolute bottom-0'/>
                        </div>
